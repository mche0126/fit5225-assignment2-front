...
import { PageHeader, Button, Row, Col, Carousel, Image } from 'antd';
...
export default function UploadPic(this: any) {
  ...
  return (
    <div>
      ...
      {current === 0 && (
        <div>
          <DragInPicture callback={detect.bind(this)} />
        </div>
      )}
      {current === 1 && (
        <div>
          ...
          <Button
            ...
            onClick={searchByTag}
          >
            Search by tags of this image
          </Button>
          <Button style={{ marginTop: '40px' }} onClick={uploadCancel}>
            Cancel Upload
          </Button>
        </div>
      )}
